...
//  }	 
 ...
 if ($CURRENT_VIEW === PUBLIC_VIEW ) {
     ...
     if ($MAXP === 0) {
       $MAXP = APP_BLOG_ULTRATHIN_MAX_POSTS; //APP_BLOG_WIDE_MAX_POSTS;
     }  
 }
...
<!--<?PHP echo(APP_LICENSE);?>-->  
  ...
  <title><?PHP echo(APP_TITLE);?> - <?PHP echo(AVATAR_NAME); ?></title>
...
<?PHP endif; ?>
  ...
  <meta name="description" content="Welcome to Foodlet! Let everyone have its food place. This a NuMode project."/>
  <meta name="keywords" content="menu,food,place,foodlet,photo,puzzle,on,premise,solution,NuMode"/>
...
<?PHP if ($CURRENT_VIEW == ADMIN_VIEW): ?>    
  ...
  <body style="background:url('/res/bg1.jpg') no-repeat; background-size: cover; background-attachment: fixed; background-position: center;">
   <div id="AFHint" style="z-index:0;">
       ...
       <br>  
      <span onclick="showHowTo();"><?PHP echo(getResource0("How-to: Manage your avatars in Foodlet", $lang));?></span>
      <br><br>
   </div>     
...
<input type="hidden" id="txtMagicJar3" name="txtMagicJar3" value="<?PHP echo($magicJar3);?>">
 ...
 <input type="hidden" id="Password" name="Password" value="<?PHP echo($password);?>"> 
  ...
  <div id="footer"><span style="background:#FFFFFF; opacity:0.7;">&nbsp;&nbsp;<a class="aaa" href="dd.html">Disclaimer</a>.&nbsp;&nbsp;A <a href="http://numode.eu" class="aaa">NuMode</a> project and <a href="http://demo.numode.eu" class="aaa">WYSIWYG</a> system. <?PHP echo(getResource0("Some rights reserved", $lang));?></span></div>
...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
             <a href="http://foodlet.org" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-5px;width:22px;">&nbsp;Foodlet</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/par7133/Foodlet" style="color:#000000;"><span style="color:#119fe2">on</span> github</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:code@gaox.io" style="color:#000000;"><span style="color:#119fe2">for</span> feedback</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+39-331-4029415" style="font-size:13px;background-color:#15c60b;border:2px solid #15c60b;color:#000000;height:27px;text-decoration:none;">&nbsp;&nbsp;get support&nbsp;&nbsp;</a>
        </div>
        <div style="float:right; position:relative; top:-10px;margin-right:200px;">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="#" onclick="showLogin()" style="margin-left:100px;">Admin</a>
              &nbsp;&nbsp;&nbsp;
        </div>     
   </div>
   <div id="headerMob" class="header" style="margin-top:18px;margin-bottom:18px;display:none">
        <div style="float:left">
             <a href="http://foodlet.org" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-5px;width:22px;">&nbsp;Foodlet</a>
        </div>   
 ...
 <div id="blog">    
   ...
   if (empty($aFilePaths)): ?>
      ...
      foreach ($aFilePaths as $filePath) {
        ...
        //$natName = explode("|",$orifilename)[1];
        //$thumbName = "thumb-" . $natName;
                          ...
                          <div class="blog-content"> 
                           <div class="blog-entry" onclick="selectVideo(<?php echo($iEntry-1);?>);" style="background:url('/img?av=<?PHP echo(AVATAR_NAME);?>&pic=<?PHP echo($orifilename);?>');background-size:100% 100%;">  
                                <?PHP if (APP_PAGINATION || (APP_BLOG_MAX_POSTS===0 || APP_BLOG_MAX_POSTS>$iCurEntry)): ?>
                                      <?PHP 
                                         $AVATAR_URI = (defined("AVATAR_NAME_WITH_DISC")?AVATAR_NAME_WITH_DISC:AVATAR_NAME); 
                                      ?>
                                       <?php if ($iCurEntry===1 && $iEntry===1): ?>
                                       <!--<img class="blog-img" src="/res/arrow-leftd.png" style="float:left;">-->
                                       <?php elseif ($iEntry===1 && $iCurEntry>1): ?>  
                                       <a href="/<?PHP echo($AVATAR_URI); ?>/?blogSP=<?PHP echo($prevPost);?>&maxp=<?PHP echo($MAXP)?>" onclick="event.stopPropagation();"><img class="blog-img" src="/res/arrow-left.png" style="float:left;"></a>
                                       <?php endif; ?>
                                       ...
                                       <?php elseif ($iEntry===$MAXP): ?>
                                          <?PHP if ($MAXP===APP_BLOG_ULTRATHIN_MAX_POSTS): ?> 
                                            <div style="float:right;position: absolute;left:+85%; opacity:1.0;"><a href="/<?PHP echo($AVATAR_URI); ?>/?blogSP=<?PHP echo($nextPost);?>&maxp=<?PHP echo($MAXP)?>" onclick="event.stopPropagation();"><br><br><br><img class="blog-img" src="/res/arrow-right.png" style="float:right;"></a></div>
                                          <?PHP elseif ($MAXP===APP_BLOG_THIN_MAX_POSTS): ?>   
                                            <div style="float:right;position: absolute;left:+82%; opacity:1.0;"><a href="/<?PHP echo($AVATAR_URI); ?>/?blogSP=<?PHP echo($nextPost);?>&maxp=<?PHP echo($MAXP)?>" onclick="event.stopPropagation();"><img class="blog-img" src="/res/arrow-right.png" style="float:right;"></a></div>                                          
                                          <?PHP else: ?>                                            
                                            <div style="float:right;position: absolute;left:+92%; opacity:1.0;"><a href="/<?PHP echo($AVATAR_URI); ?>/?blogSP=<?PHP echo($nextPost);?>&maxp=<?PHP echo($MAXP)?>" onclick="event.stopPropagation();"><img class="blog-img" src="/res/arrow-right.png" style="float:right;"></a></div>
                                          <?php endif; ?>  
                                       <?php endif; ?>
                                 <?PHP else: ?>
                                       &nbsp;
      ...
      foreach($aLinks as $aLink) { ?>
                    ...
                    <div class="modal" tabindex="-1" role="dialog" id="modal<?php echo($iLink);?>" style="z-index:99997;margin-top:10px;">
                      <div class="modal-dialog modal-lg" role="document" style="width:95%;margin-top:0;background-color:#FFFFFF;z-index:99998">
                        <div class="modal-content" style="float:left;width:content-box;max-width:60%;-index:99999;">
 ...
 ?>          
  ...
  <div id="footerCont">&nbsp;</div>
  <div id="footer1" style="float:left; width:80px; display:none;">
  ...
  function setHalPos() {
   ...
   // }
    if (parseInt(bodyRect.width) > 1200) {
      ...
      $("span#halTerm").css("left", "+28%");
      $("div#halBoard").css("left", "+29%");
    } else {
      $("span#halTerm").css("left", "+18%");
      $("div#halBoard").css("left", "+19%");
...
<script>
 ...
 function setContentPos() {
    ...
    // xxx: it was picw..
    $(".blog-content").css("width", (picw-4) + "px");
