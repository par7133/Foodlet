...
?>
 ...
 <?PHP if ($lang == PHP_EN): ?>
   ...
   alert("Here how to manage your avatars in Foodlet\n" +
         ...
         "   a. Drop in pic to shape your blog; the first one as yr avatar picture.\n" +
  ...
  <?PHP elseif ($lang == PHP_IT): ?>       
   ...
   alert("Ecco come gestire i tuoi avatar in Foodlet:\n" +
         ...
         "   a. Trascina immagini per creare il blog; la prima sara' il tuo avatar.\n" +
